...
// Optimized for Solana Playground Deployment
// 
// INSTRUCTIONS:
// 1. Go to https://beta.solpg.io/
// 2. Create new Anchor project
// 3. Replace src/lib.rs with this entire file
// 4. Click Build
// 5. Copy the Program ID shown
// 6. Replace the declare_id! below with your Program ID
// 7. Build again
// 8. Click Deploy
// 9. Copy the deployed Program ID to backend/.env
