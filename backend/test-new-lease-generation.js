...
async function testNewLeaseGeneration() {
  console.log('\n🧪 Testing New Lease Generation Process...\n');
  ...
  try {
    ...
    // Now test the lease generation process
    console.log('\n4. Testing lease generation with new application...');
    ...
    console.log('🎉 New lease generation test completed successfully!');
...
testNewLeaseGeneration().catch(console.error);